...
const projects: Project[] = [
  {
    ...
    overview: 'В інтерʼєрі ми використали спокійну кольорову гаму, дерев’яні меблі та натуральний текстиль, що дають відчуття поєднання з природою. Розташована поряд відкрита лаунж зона дає можливість відпочити та розслабитись. Зверніть увагу на поєднання міксу дерев’яних кухонних фасадів та фартуху з каменю, які виглядають цілісно та гармонійно. Центральне місце в будинку займає камін, який створює відчуття максимального комфорту та затишку.',
    category: 'interior',
  ...
  },
  {
    ...
    slug: 'kozyn-2',
    name: 'Kozyn 2',
    title: 'Дизайн-проєкт будинку в стилі мінімалізм Kozyn',
