    ...
    <div className="bg-white py-14 sm:py-32">
      ...
      <div className="mx-auto max-w-lg xl:max-w-4xl px-4 lg:px-8">
        ...
        <div className="mt-12 md:mt-14 flex">
          <a
            href="#"
            className="border border-black bg-white py-3 px-10 md:px-8 xl:px-16 xl:py-4 text-[11px] text-xs tracking-wider font-medium text-black hover:text-white hover:bg-black"
          >
            ДІЗНАТИСЯ БІЛЬШЕ
          </a>
        </div>
