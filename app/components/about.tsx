  ...
  return (
    <div className="bg-white py-14 sm:py-32">
      ...
      <div className="mx-auto max-w-lg xl:max-w-4xl px-4 lg:px-8">
        ...
        <div className="mt-7 md:mt-10 grid grid-cols-1 gap-3 xl:gap-8 text-xs xl:text-sm xl:tracking-wide font-extralight leading-5 xl:leading-6 text-[#666] xl:grid-cols-2">
          <p>
