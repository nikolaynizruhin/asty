  ...
  return (
    <div className="bg-white pt-24 xl:pt-56 px-4 md:px-8 xl:px-16 max-w-[550px] mx-auto md:max-w-none">
      ...
      <div className="text-xs text-[#828282] mt-11">
        <Link href='/projects' className={`${category ? '' : 'text-[#121212]' } mr-5 md:mr-12 xl:mr-24 pr-4 xl:uppercase font-semibold`}>Всі</Link>
        <Link href='/projects?category=architecture' className={`${category === 'architecture' ? 'text-[#121212]' : '' } mr-5 md:mr-12 xl:mr-24 pr-4 xl:uppercase font-semibold`}>Архітектура</Link>
        <Link href='/projects?category=interior' className={`${category === 'interior' ? 'text-[#121212]' : '' } mr-5 md:mr-12 xl:mr-24 pr-4 xl:uppercase font-semibold`}>Інтерʼєр</Link>
        <Link href='/projects?category=commerce' className={`${category === 'commerce' ? 'text-[#121212]' : '' } xl:uppercase font-semibold`}>Комерція</Link>
      </div>
