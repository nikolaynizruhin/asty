...
const services = [
  ...
  },
  {
    ...
    description: 'Розробка архітектурних проєктів відбувається з урахуванням особливостей ділянки та відповідно до будівельних норм та стандартів. Важливою складовою всьго процесу проектування є ваше бачення та бажання.',
