  ...
  return (
    <div className="mt-8 md:mt-12 xl:mt-20 mb-6 xl:mb-8">
      <div className="flex items-center">
        ...
        <label htmlFor="terms" className="ml-3 text-sm xl:text-base text-[#828282]">Я даю згоду на обробку <Link href="/privacy" className="hover:text-white underline">персональних даних</Link></label>
      </div>
