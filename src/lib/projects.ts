...
const projects: Project[] = [
  {
    ...
    overview: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ornare finibus tortor, ut porta nisl semper a. Cras eu nisi a odio rhoncus mattis. Aliquam eu placerat ex. Nulla sodales, diam eu lobortis egestas, lorem risus fermentum nisi, in interdum justo dolor id ipsum. Fusce ut eros vitae massa lobortis accumsan eu a lacus. Vestibulum vehicula erat nulla, aliquet convallis est vulputate vitae. Mauris in velit rhoncus, dignissim enim et, ultricies quam. Nunc sit amet facilisis risus. Sed in enim vitae sapien facilisis maximus a at enim. Integer tincidunt tincidunt sem ut viverra. In elementum varius facilisis. Proin non iaculis ligula. Donec rhoncus nunc non volutpat varius. Ut euismod laoreet risus ac accumsan. Nunc in ex convallis, tempor ligula vel, blandit lacus. Vestibulum at velit et odio pharetra pellentesque.',
    category: 'interior',
    details: [
      {
        icon: "geo-alt",
