...
const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: 'Monochrome interior in the shade of the Spanish sun',
    description: "Цей інтер'єр вражає своєю гармонією, використанням природних матеріалів та стильними деталями, що створюють сучасну та затишну атмосферу. Кольорова гама включає в себе різні відтінки сірого та білого у поєднанні з деревом. Стіни прикрашені панелями, які додають текстур і природності до інтер'єру, створюючи гармонійний фон для всього простору. На стелі встановлена акцентна чорна підсвітка, яка створює враження легкості і елегантності. Це освітлення є не лише джерелом світла, але і стильним дизайнерським елементом. Кухонний острів стає центром уваги та практичним елементом інтер'єру. Його поверхня виконана у сірому кольорі, що доповнює загальну кольорову гаму. Острів служить як функціональний робочий простір, а також місце для сніданків чи неформальних обідів.",
    details: [
      {
        icon: "geo-alt",
        title: "Локація",
